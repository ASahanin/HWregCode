...
public class DbWorkerReg {
    private final String url = "jdbc:postgresql://localhost:5432/8080";
    ...
    private void insertLogs(String login, boolean isTruePassword) {
        String SQL = "insert into userlogs (user_login, lastLogin, loginSuccess) values (?, current_timestamp, ?);";
        try(Connection conn = connect();
            PreparedStatement preparedStatement = conn.prepareStatement(SQL)) {
    ...
    public void authorization(String login, int password){
